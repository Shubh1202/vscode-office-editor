...
2. Right-click any `.docx` or `.xlsx` file in the Explorer.
3. Select **Open With...** and choose **Office Editor**.
4. Start editing — press `Ctrl+S` to save.
...
- Search is limited to the active document view.
